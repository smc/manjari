...
test: ttf otf $(PDFS)
	...
	fontbakery check-googlefonts -x com.google.fonts/check/name/license -x com.google.fonts/check/version_bump -x com.google.fonts/check/repo/zip_files -x com.google.fonts/check/metadata/escaped_strings -x com.google.fonts/check/glyf_nested_components $(BLDDIR)/*.ttf
