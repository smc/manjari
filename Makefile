...
test: ttf otf $(PDFS)
	...
	fontbakery check-googlefonts -x com.google.fonts/check/version_bump -x com.google.fonts/check/repo/zip_files -x com.google.fonts/check/metadata/escaped_strings $(BLDDIR)/*.ttf
